...
public sealed class AssetMaintenanceApiTests : IClassFixture<IsolatedOperationsApiFactory>
{
    ...
    public AssetMaintenanceApiTests(IsolatedOperationsApiFactory factory)
    {
